...
public class SpringBootCompositionRootConsoleApplication
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(SpringBootCompositionRootConsoleApplication.class);

    private static final String PATIENT_KEY = "CRPat123";

    private ApplicationContext iocContext;

    public static void main(String[] args) {
        LOGGER.info("STARTING THE APPLICATION");
        SpringApplication.run(SpringBootCompositionRootConsoleApplication.class, args);
